...
class StructureVersionUpdater implements EventSubscriberInterface
{
    ...
    {
        return [
            StorageEvents::POST_SAVE => 'updateStructureVersion'
        ];
    }

    /**
     * Updates the structure version for the saved entity
     */
    public function updateStructureVersion(GenericEvent $event)
    {
        $sql = <<<'SQL'
